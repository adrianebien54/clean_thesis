...
anchor pulled from each net's new-LOG_PARA LR grid under exp/aa_final/:

  CSRNet      lp25  AdamW@1e-4  exp/aa_final/csrnet_logpara100_anchor772x519_06-20_14-41/csrnet_logpara_results.json
  MobileCount lp639 AdamW@1e-3  exp/aa_final/mobilecount_logpara2550_anchor772x519_06-17_14-26/mobilecount_logpara2550_results.json
...
SOURCES = [
    (str((OUT_DIR / "batchsize_logpara_results.json").relative_to(ROOT)),
     lambda r: True),
    ("exp/aa_final/csrnet_logpara100_anchor772x519_06-20_14-41/csrnet_logpara_results.json",
     lambda r: r.get("net") == "CSRNet" and r.get("optimizer") == "AdamW"
     and abs(float(r.get("lr", 0)) - 1e-4) < 1e-12 and r.get("batch_size") == 6),
    ("exp/aa_final/mobilecount_logpara2550_anchor772x519_06-17_14-26/mobilecount_logpara2550_results.json",
