...
NOT re-run here -- they live in the new-LOG_PARA LR grids under exp/aa_final/ and are
...
# bs6 is the LR-grid optimum (in exp/aa_final/), NOT re-run here. sqrt(bs/6)-scaled
